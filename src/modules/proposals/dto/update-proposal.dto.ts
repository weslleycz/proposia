...
export class UpdateProposalDto extends PartialType(CreateProposalDto) {
  ...
  @ApiProperty({ description: 'Descrição da proposta', required: false, example: 'Proposta atualizada para o cliente X' })
  @IsOptional()
  description?: string | undefined;


  @ApiProperty({ description: 'Título da proposta', required: false, example: 'Proposta Comercial - Versão 2' })
  @IsOptional()
